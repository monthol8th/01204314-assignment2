let domImport = document.getElementById("treemap_import");
let importChart = echarts.init(domImport);
let importApp = {};
option = null;
importChart.showLoading();
              ...
              function(kenData) {
                $.get(
                  ...
                  function(cmrData) {
                    ...
                    function colorMimportAppingChange(value) {
